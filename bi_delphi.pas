...
procedure splitstringex(const inp: string; var out1, out2: string; const splitter: char); overload;

procedure splitstringex(const inp: string; var out1, out2, out3: string; const splitter: char); overload;

procedure splitstringex(const inp: string; var out1, out2, out3, out4: string; const splitter: char); overload;

procedure splitstringex(const inp: string; var out1, out2, out3, out4, out5: string; const splitter: char); overload;

procedure splitstringex(const inp: string; var out1, out2: string; const splitters: charset_t); overload;
...
begin
  if Assigned(outproc) then
    outproc(str+sLineBreak)
  else if IsConsole then
    write(str+sLineBreak);
end;
...
procedure splitstringex(const inp: string; var out1, out2: string; const splitter: char);
var
  p: integer;
begin
  p := Pos(splitter, inp);
...
procedure splitstringex(const inp: string; var out1, out2: string; const splitters: charset_t);
var
  i: integer;
  p: integer;
  inp1: string;
...
var
  tmp: string;
begin
  splitstringex(inp, result, tmp, splitter);
end;
...
var
  tmp: string;
begin
  splitstringex(inp, result, tmp, splitters);
end;
...
var
  tmp: string;
begin
  splitstringex(inp, tmp, result, splitter);
end;
...
var
  tmp: string;
begin
  splitstringex(inp, tmp, result, splitters);
end;
